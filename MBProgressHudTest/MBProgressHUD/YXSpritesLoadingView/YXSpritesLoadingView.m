...
- (id)init
{
    ...
    window = [[UIApplication sharedApplication] keyWindow];//[delegate respondsToSelector:@selector(window)] ? [delegate performSelector:@selector(window)] : [[UIApplication sharedApplication] keyWindow];
	self.alpha = 0;
	return self;
}
...
- (NSArray *)imagesForAnimatingWithImageArr:(NSArray *)imagesArr
{
//    NSMutableArray *retVal = [NSMutableArray array];
//    for (int i = 0; i < [imagesArr count]; i++) {
//        
//        [retVal addObject:[imagesArr objectAtIndex:i]];
//        
//    }
//    
//    return retVal;
