...
#define kFe_WifiMan_Width 100//85.0f
#define kFe_WifiMan_Height 100//85.0f
...
-(id) initWithView:(UIView *)view withMode:(FeWifiManHubMode)mode
{
    ...
    {
        _containerView = view;
        self.frame = CGRectMake(0, 0, kFe_WifiMan_Width, kFe_WifiMan_Height);
...
-(void) initWifimanImageView
{
    ...
    UIImage *imageColored = [UIImage imageNamed:@"patient_1"];
    UIImage *imageGray = [UIImage imageNamed:@"patient_1"];
...
-(void) show
{
    ...
    for (int i = 0; i < 8; i++) {
        ...
        UIImage * image = [UIImage imageNamed:[NSString stringWithFormat:@"patient_%d", i+1]];
    ...
    [_contentLayer addAnimation:anim forKey:@"contents"];
